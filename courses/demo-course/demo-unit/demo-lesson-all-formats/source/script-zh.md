...
{
  "props": {
    "images": [{"src": "assets/diagram-system-boundary.png"}],
    "eyebrow": "组件",
    "title": "SplitImage",
    "subtitle": "左侧说明，右侧证据图。",
    "bullets": [
...
{
  "props": {
    "videoSrc": "assets/fake-ide-walkthrough.mp4",
...
{
  "props": {
    "images": [{"src": "assets/diagram-system-boundary.png"}, {"src": "cover/hero.svg"}],
    "eyebrow": "组件",
